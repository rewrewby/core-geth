		...
		Subcommands: []*cli.Command{
			{
				...
				Description: `
core-geth snapshot prune-state <state-root>
...
`,
			},
			{
				...
				Description: `
core-geth snapshot verify-state <state-root>
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabaseFlags),
				Description: `
core-geth snapshot check-dangling-storage <state-root> traverses the snap storage
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabaseFlags),
				Description: `
core-geth snapshot inspect-account <address | hash> checks all snapshot layers and prints out
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabaseFlags),
				Description: `
core-geth snapshot traverse-state <state-root>
...
`,
			},
			{
				...
				Flags:     flags.Merge(utils.NetworkFlags, utils.DatabaseFlags),
				Description: `
core-geth snapshot traverse-rawstate <state-root>
...
`,
			...
			{
				Name:      "dump",
				Usage:     "Dump a specific block from storage (same as 'core-geth dump' but using snapshots)",
				...
				Description: `
This command is semantically equivalent to 'core-geth dump', but uses the snapshots
