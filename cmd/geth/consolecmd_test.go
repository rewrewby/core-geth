...
const (
	ipcAPIs  = "admin:1.0 debug:1.0 eth:1.0 ethash:1.0 miner:1.0 net:1.0 rpc:1.0 trace:1.0 txpool:1.0 web3:1.0"
...
func TestConsoleWelcome(t *testing.T) {
	...
	geth.Expect(`
Welcome to the Core-Geth JavaScript console!
...
func testAttachWelcome(t *testing.T, geth *testgeth, endpoint, apis string) {
	// Attach to a running core-geth node and terminate immediately
